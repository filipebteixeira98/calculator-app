...
export function ConverterScreen() {
  ...
  const conversionResult = hasValidInput
    ? numericValue * selectedConversion.conversionRate
    : null;
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Type a value and choose one conversion option.
          </Text>
        </View>
        ...
        <View style={styles.optionsContainer}>
          ...
          {conversionOptions.map((conversionOption) => {
            ...
            return (
              <Pressable
                key={conversionOption.id}
                onPress={() => setSelectedConversion(conversionOption)}
                style={({ pressed }) => [
                  styles.optionButton,
              ...
              >
                <View>
                  ...
                  >
                    {conversionOption.sourceUnit} to{' '}
                    {conversionOption.targetUnit}
                  </Text>
                </View>
              </Pressable>
            );
        ...
        <View style={styles.resultContainer}>
          ...
          >
            {conversionResult === null
              ? '0'
              : formatConversionResult(conversionResult)}
          </Text>
